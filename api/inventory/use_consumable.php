...
try {
    ...
    $stmtCheck->execute([$target_owner_id, $consumable_id]);
    ...
    $stmtUpdate->execute([$new_qty, $target_owner_id, $consumable_id]);
    ...
    // ลอง execute ดูก่อน
    try {
        $stmtLog->execute([$consumable_id, $qty, $target_owner_id]);
    } catch (Exception $e) {
