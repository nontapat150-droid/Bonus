...
<div class="space-y-6">
    ...
    <div class="kpi-grid mb-6">
        <div class="card !p-6 bg-slate-50 border border-slate-200">
            ...
            <h3 id="stat_total_records" class="mt-4 text-3xl font-black text-slate-900">0</h3>
        </div>
        <div class="card !p-6 bg-slate-50 border border-slate-200">
            <p class="text-[10px] uppercase tracking-[0.3em] text-slate-400 font-black">ยอดเงินรวม (บาท)</p>
            <h3 id="stat_total_cost" class="mt-4 text-3xl font-black text-slate-900">0.00</h3>
        </div>
        <div class="card !p-6 bg-slate-50 border border-slate-200">
            <p class="text-[10px] uppercase tracking-[0.3em] text-slate-400 font-black">ปริมาณน้ำมันรวม (ลิตร)</p>
            <h3 id="stat_total_liters" class="mt-4 text-3xl font-black text-slate-900">0.00</h3>
        </div>
        <div class="card !p-6 bg-slate-50 border border-slate-200">
            <p class="text-[10px] uppercase tracking-[0.3em] text-slate-400 font-black">ระยะทางรวม (กม.)</p>
