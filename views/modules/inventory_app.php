...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 flex items-center">
                <span class="mr-2 text-3xl">📦</span> ระบบคลังสินค้า (Inventory)
            </h2>
            <p class="text-gray-500 text-sm mt-1">จัดการสต๊อก นำเข้า เบิกจ่าย และดูประวัติ</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div class="relative w-full sm:w-64">
                    <input type="text" id="searchStock" placeholder="ค้นหาสินค้า หรือ โมเดล..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-purple-500">
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3">โมเดล (Model)</th>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <form id="inboundForm" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">โมเดล (Model) <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Serial Number (SN) <span class="text-gray-400 font-normal">(เว้นว่างไว้เพื่อสร้าง Auto-Generate)</span></label>
    ...
    <div id="view-outbound" class="inv-view hidden space-y-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="font-bold text-gray-700 mb-4 border-b pb-2">สแกนเบิกสินค้าออก (Staging)</h3>
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-3">ชื่อสินค้า - โมเดล</th>
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3">SN</th>
                            <th class="px-6 py-3">สินค้า - โมเดล</th>
                            <th class="px-6 py-3">แอดมินผู้ทำรายการ</th>
                        </tr>
                    </thead>
    ...
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-2xl w-full flex flex-col max-h-[90vh] transform transition-all">
        ...
        <div class="p-6 overflow-y-auto">
            <div id="printBillArea" class="space-y-4">
                <div class="text-center mb-6 border-b pb-4 border-dashed border-gray-300">
                    <h2 class="text-xl font-bold uppercase text-gray-800">SmartSuite Warehouse</h2>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="border-b-2 border-gray-800">
                        <tr>
                            <th class="py-2">No.</th>
                            <th class="py-2">รายการ (สินค้า - โมเดล)</th>
                            <th class="py-2 text-right">S/N</th>
                        </tr>
                    </thead>
        ...
        <div class="p-4 border-t bg-gray-50 flex justify-end space-x-3">
            ...
            <button id="finalSubmitOutbound" class="px-6 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 font-bold shadow-md flex items-center">
                <span class="mr-2">✅</span> ยืนยันตัดสต๊อกทันที
            </button>
        </div>
    </div>
</div>
