        ...
        <div class="bg-white rounded-[2rem] shadow-xl p-6 border border-gray-50 flex-1 flex flex-col">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                <div>
                    ...
                    <div class="flex gap-2 p-1.5 bg-white rounded-2xl shadow-sm border border-slate-100 max-w-[240px]">
                        <button type="button" id="histTabCheckin" onclick="switchHistoryMode('checkin')" class="flex-1 py-2 rounded-xl text-sm font-black transition-all bg-indigo-600 text-white">เข้างาน</button>
                        <button type="button" id="histTabCheckout" onclick="switchHistoryMode('checkout')" class="flex-1 py-2 rounded-xl text-sm font-black transition-all text-slate-500 hover:bg-slate-50">เลิกงาน</button>
                    </div>
                </div>
